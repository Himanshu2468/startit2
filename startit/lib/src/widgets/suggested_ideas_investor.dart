...
class SuggestedIdeasInvestor extends StatefulWidget {
  @override
  _SuggestedIdeasInvestorState createState() => _SuggestedIdeasInvestorState();
}

class _SuggestedIdeasInvestorState extends State<SuggestedIdeasInvestor> {
    ...
    for (Map idea in jsonData) {
      suggestedIdeaData.add(
        SuggestedIdeaModel(
            ...
            name: idea["idea_person_name"] != null
                ? idea["idea_person_name"]
                : "",
