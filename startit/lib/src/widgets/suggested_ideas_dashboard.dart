...
class SuggestedIdeasDashboard extends StatefulWidget {
  @override
  _SuggestedIdeasDashboardState createState() =>
      _SuggestedIdeasDashboardState();
}

class _SuggestedIdeasDashboardState extends State<SuggestedIdeasDashboard> {
